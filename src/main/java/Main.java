public class Main {
    ...
    Passenger passenger57=new Passenger("Passenger57",planeTicket,900.0,new String[]{"carryon","personal"});
    Passenger passenger07=new Passenger("Passenger07",planeTicket,2000.0,new String[]{});
